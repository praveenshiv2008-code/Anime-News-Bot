...
def load_rss_feeds():
    """Load the list of RSS feed URLs from file. If missing, create with default."""
...
def fetch_news(limit=10):
    """Fetch news from all configured RSS feeds, deduplicate by link."""
    ...
    # Return as list of tuples (title, summary, link)
    return list(all_entries.values())[:limit]

# ---------- TMDb Image Fetch (for news) ----------
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            if results:
                ...
                img_url = images.get("jpg", {}).get("image_url", None)
                return {
...
# ---------- Fanart.tv image fetch (optional) ----------
